    ...
    <a href="#" class="list-group-item list-group-item-action d-flex bd-highlight overflow-hidden">
        <details class="list-group-item d-flex bd-highlight p-0 overflow-hidden">
            <summary class="row container list-group-item d-flex text-start align-items-center justify-content-between">
                <div class=" col-md-3 col-6 flex-d bd-highlight">
                    <input class="form-check-input me-3 overflow-auto" type="checkbox" value="" id="flexCheckChecked"
                ...
                <div class="col-md-5 col-6 overflow-hidden flex-d bd-highlight">
                    <h5 class="form-check">{{ tarea.title }}</h5>
                </div>
                <div class="container col d-flex justify-content-center pt-3 pt-md-0">
                    <a id="importante" href="#" v-if="tarea.important" @click="toggleImportante">
                    ...
                    <a id="importante" href="#" v-else @click="toggleImportante">
                        <svg xmlns="http://www.w3.org/2000/svg" height="25" width="25" viewBox="0 0 576 512">
                            <path fill="#ffffff"
                ...
                <div class="container col d-flex justify-content-center pt-3 pt-md-0">
                    <a id="editar" href="#" @click="actualizarTarea">
                ...
                <div class="container col d-flex justify-content-center pt-3 pt-md-0">
                    <a id="borrar" href="#" @click="eliminarTarea">
