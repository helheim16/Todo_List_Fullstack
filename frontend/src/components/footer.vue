    ...
    <div class="overflow-hidden text center footer">
        <div class=" row list-group-item d-flex  justify-content-between">
            ...
            <div class="col-6 justify-content-between">
                ...
                <p><a href="https://github.com/TalyB19">Beltran Niz, Aylen N</a></p>
            </div>
            <div class="col-6 justify-content-between">
                <svg xmlns="http://www.w3.org/2000/svg" height="30" width="30" viewBox="0 0 496 512">
                    <path fill="#ffffff"
                ...
                <p><a href="https://github.com/helheim16">Bouquet Sahuet, Yago</a></p>

            </div>
        </div>
        <div class="row">
            <div class="col-12 text-light-emphasis">

                <hr>
                <a>@ 2023 Boubel Corporation - Todo List</a>
...
export default class Footer extends Vue {
    name = 'TodoListFullstackFooter';
};
</script>

<style  scoped>
.footer {
    background-image: linear-gradient(120deg, #1a0b34, #442474);
    position: relative;
    margin-top: 60px;
    margin-left: 0;
    margin-right: 0;
